...
produtoAdd.cadastrarProdutos('pendrive',50, 30.0)
...
console.log(produtoAdd.listarEstoqueVazio())
// LOG DE COMPRAS
console.log(userAdd.checarCompras("Eduardo"))
console.log(userAdd.checarCompras("Thiago"))